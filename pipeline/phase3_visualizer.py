...
def plot_bgc_class_distribution(
    ...
    active_classes = [c for c in BGC_CLASSES if c != "Non-BGC"]
...
<style>
  ...
  .badge-nrps   { background:#E63946; }
  .badge-pksi   { background:#F4A261; }
  .badge-pksii  { background:#E9C46A; color:#333; }
  .badge-terp   { background:#2A9D8F; }
  .badge-ripp   { background:#457B9D; }
  .badge-other  { background:#9B5DE5; }
  .badge-non    { background:#AAAAAA; }
...
<header>
  ...
  <p>AI-assisted (PyTorch mock-inference) Biosynthetic Gene Cluster scoring of Alien HGT genes</p>
</header>
<div class="container">
...
<div class="stats-grid">
  ...
  <div class="stat-card"><div class="val">{{ "PyTorch" if stats.torch_used else "NumPy" }}</div>
...
<footer>PanAdapt-BGC Miner &bull; Phase 3 Report &bull; Generated by BGCPredictor (mock inference)</footer>
</body>
</html>
"""
